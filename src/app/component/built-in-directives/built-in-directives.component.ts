...
export class BuiltInDirectivesComponent implements AfterViewInit, OnInit {
   ...
   title: string = 'Content projection';
   subtitle: string = '';
   ...
   ngOnInit(): void {
      ...
      console.log('str.substring(7,str.length)', str.substring(7,str.length)); //890
      ...
      console.log('st expression=[...(isTrue ? [1, testing] : [2])]')
      console.log('st true', this.checkIsTrue(true))
      console.log('st false', this.checkIsTrue(false))

      console.log('st2 expression={...(isTrue ? { val1: 1, val2: testing} : {val1:1})}')
      console.log('st2 true', this.checkIsTrue2(true))
      console.log('st2 false', this.checkIsTrue2(false))
   }

   checkIsTrue(isTrue:boolean) {
      return [...(isTrue ? [1, 'testing'] : [2])];
   }

   checkIsTrue2(isTrue:boolean) {
      return {...(isTrue ? { val1: 1, val2: 'testing'} : {val1:1})};
   }
